...
export default {
	onLaunch: function() {
		uni.onTabBarMidButtonTap(function() {
			uni.navigateTo({
				url: '/pages/tarbar/redpacket/redpacket'
			});
		});
	...
	// old
	// 69e776bb51c3a264cf364a97
	// 4f7f3575a6910c9560f3d966

	// new
	// 07a987a5aae3ef43d0ce4aa1
	// 1e10bb122ac861ac18a583fe

	onShow: function() {
		console.log('App Show');
		Vue.prototype.JIM = new JMessage({});
		var appkey = '07a987a5aae3ef43d0ce4aa1';
		var key = '1e10bb122ac861ac18a583fe';
		var timestamp = new Date().getTime();
		var signature = md5('appkey=07a987a5aae3ef43d0ce4aa1&timestamp=' + timestamp + '&random_str=022cd9fd995849b66666&key=1e10bb122ac861ac18a583fe');
		...
		this.JIM.init({
			...
			.onSuccess(function(data) {
				console.log('JIM初始化成功', data);
			})
			.onFail(function(data) {
				//TODO
				console.log('JIM初始化失败', data);
			});
		//
